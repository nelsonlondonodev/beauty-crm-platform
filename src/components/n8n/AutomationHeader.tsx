...
const AutomationHeader = () => (
  <section className="animate-in fade-in slide-in-from-left-12 duration-1000">
    <div className="mb-6 flex items-center gap-2 rounded-full border border-purple-400/20 bg-purple-500/10 px-4 py-1.5 text-xs font-black uppercase tracking-widest text-purple-400 w-fit">
    ...
    <h1 className="text-5xl font-black tracking-tight text-white leading-[1.1] sm:text-6xl">
      ...
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-primary to-indigo-400 italic">Bienvenida Real-Time.</span>
    </h1>
    ...
    <div className="mt-12 space-y-4">
       {[
         ...
         <div key={item.text} className="flex items-center gap-4 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 transition-colors group-hover:border-purple-500/50">
